...
urlpatterns = [
    ...
    url(r"^api/appliances", include("storageadmin.urls.appliances")),
    ...
    url(r"^api/users", include("storageadmin.urls.users")),
    url(r"^api/groups", include("storageadmin.urls.groups")),
    ...
    # update subscription
    url(r"^api/update-subscriptions", include("storageadmin.urls.update_subscription")),
]
